<template>
  <div class="ratings" ref="ratings" v-if="ratings && info">
      ...
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <Stars :rating="info.serviceScore" :size="36" />
          ...
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <Stars :rating="rating.score" :size="24" />
...
<script>
  ...
  export default {
    ...
    mounted () {
      if (!this.info && !this.ratings) return
      this.$nextTick(() => {
        this.commentBS = new BScroll(this.$refs.ratings, {
          click: true
        })
      })
    ...
    computed: {
      ...
      filterRatings () {
        ...
        // 产生一个过滤新数组
        let temp = ratings.filter(rating => {
